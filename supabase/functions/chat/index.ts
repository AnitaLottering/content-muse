  ...
  try {
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "You are a helpful AI assistant specialized in content generation. Help users choose prompts, improve their inputs, and explain generated content. Be conversational, clear, and helpful. Use markdown formatting when appropriate." },
          ...messages,
        ],
        stream: true,
      }),
